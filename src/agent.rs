...
trait AgentKey<U> {
    ...
    where
        ...
        R: Into<U> + Copy,
    {
        self.get_space().try_read_key::<T, R>(field, key)
    }
    ...
    {
        self.get_space().read_all_key::<T, R>(field, key)
    }
    ...
    where
        ...
        R: Into<U> + Copy,
    {
        self.get_space().read_key::<T, R>(field, key)
    }
    ...
    where
        ...
        R: Into<U> + Copy,
    {
        self.get_space().try_take_key::<T, R>(field, key)
    }
    ...
    where
        ...
        <Self as AgentKey<U>>::Space: 'a,
    {
        self.get_space().take_all_key::<T, R>(field, key)
    }
    ...
    where
        ...
        R: Into<U> + Copy,
    {
        self.get_space().take_key::<T, R>(field, key)
    }
}
